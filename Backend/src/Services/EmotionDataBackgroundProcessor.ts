...
try {
  connection = new IORedis(connectionString ? connectionString : '', { // TODO: Create new redis service berfore the experiment
...
export const emotionProcessQueue = connection ? new Queue('EmotionProcessingQueue', { connection }) : { add: (a: String, b: Object) => { } };
